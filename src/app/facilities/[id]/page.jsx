...
import {
    ...
    ArrowLeft, Calendar, CheckCircle2, ChevronRight, Lock
} from "lucide-react";
                    ...
                    <div className="lg:col-span-5">
                        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-xl sticky top-6">
                            ...
                            <p className="text-xs text-zinc-500 font-medium mb-6">
                                Fill in the details to complete your arena booking.
                            </p>
                            ...
                            {successMessage ? (
                                <div className="bg-lime-500/10 border border-lime-500/20 rounded-xl p-6 text-center flex flex-col items-center gap-3 py-10">
                                    ...
                                    <p className="text-zinc-600 text-xs">Redirecting to My Bookings...</p>
                                    <Link href="/facilities" className="mt-2 text-xs font-black text-lime-400 uppercase tracking-widest hover:underline">
                                        Book Another Arena
                                    </Link>
                                </div>
                            ) : (
                                <form onSubmit={handleBooking} className="flex flex-col gap-4">
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-[10px] text-zinc-400 font-black uppercase tracking-widest flex items-center gap-1">
                                            Your Name <Lock className="w-2.5 h-2.5 text-zinc-600" />
                                        </label>
                                        <input
                                            type="text"
                                            value={session?.user?.name || ""}
                                            readOnly
                                            className="w-full h-11 px-4 rounded-xl bg-zinc-950 border border-zinc-800 text-zinc-500 text-sm cursor-not-allowed select-none"
                                        />
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-[10px] text-zinc-400 font-black uppercase tracking-widest flex items-center gap-1">
                                            Email Address <Lock className="w-2.5 h-2.5 text-zinc-600" />
                                        </label>
                                        <input
                                            type="email"
                                    ...
                                    {session?.user ? (
                                        ...
                                        <Link
                                            href="/login"
                                            className="mt-2 w-full h-11 rounded-xl bg-lime-500 hover:bg-lime-400 text-black font-black text-xs uppercase tracking-widest flex items-center justify-center gap-2 transition-all active:scale-[0.98] shadow-[0_4px_20px_rgba(163,230,53,0.15)]"
                                        >
