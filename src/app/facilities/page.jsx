...
//                     onError={(e) => {
//                         e.currentTarget.src = "https://placehold.co/400x200/18181b/a3e635?text=SportNest";
//                     }}
//                 />
//                 <span className={`absolute top-3 left-3 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border text-[10px] font-black uppercase tracking-widest ${color.badge}`}>
//                     <span className={`w-1.5 h-1.5 rounded-full ${color.dot}`} />
//                     {facility.type}
//                 </span>
//                 <span className="absolute top-3 right-3 inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-black/60 backdrop-blur-sm border border-zinc-700 text-white text-[11px] font-black">
...
//                             className="h-11 px-4 rounded-xl border border-zinc-800 text-zinc-400 hover:text-white hover:border-zinc-700 text-xs font-black uppercase tracking-widest transition-all flex items-center gap-2"
//                         >
...
//                                         <button
//                                             onClick={clearFilters}
//                                             className="mt-4 text-xs text-lime-400 font-black uppercase tracking-widest hover:text-lime-300 transition-colors"
//                                         >
//                                             Clear Filters
//                                         </button>
//                                     </div>
