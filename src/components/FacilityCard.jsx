...
export default function FacilityCard({ facility }) {
    return (
        <div className="card bg-zinc-900 border border-zinc-800 shadow-xl hover:border-lime-500/50 transition-all duration-300 overflow-hidden group">
            {/* প্যারেন্ট ডিভে relative এবং নির্দিষ্ট h-48 w-full রাখা হয়েছে */}
            <figure className="relative h-48 w-full overflow-hidden">
                <Image
                    src={facility.image || "https://images.unsplash.com/photo-1534438327276-14e5300c3a48"}
                    alt={facility.name}
                    fill // 👈 এটি ব্যবহার করলে আলাদা করে width/height দিতে হয় না, প্যারেন্ট সাইজ অনুযায়ী বসে যায়
            ...
            <div className="card-body p-5">
                ...
                <p className="text-zinc-400 text-sm line-clamp-2 min-h-[40px]">{facility.description}</p>

                <div className="flex justify-between items-center mt-4 pt-4 border-t border-zinc-800/60">
                    {/* JSON কী (key) অনুযায়ী facility.price কে facility.pricePerHour করা হয়েছে */}
